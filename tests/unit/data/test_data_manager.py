...
class TestDataManager:
    ...
    def mock_loaders(self):
        ...
        mock_mckinsey.load.return_value = {
            "competitive_position": pd.DataFrame(
                {"company": ["A", "B", "C"], "score": [8.5, 7.2, 6.8]}
            )
        }

        return {"AIIndexLoader": mock_ai_index, "McKinseyLoader": mock_mckinsey}
    ...
    def test_get_data_with_cache_hit(self, data_manager):
        ...
        # Setup cache
        test_data = {"test": "data"}
        data_manager.cache["ai_index"] = {"data": test_data, "timestamp": datetime.now()}
    ...
    def test_cache_expiration(self, data_manager, mock_loaders):
        ...
        data_manager.cache["ai_index"] = {"data": {"old": "data"}, "timestamp": expired_time}
        data_manager.loaders["ai_index"] = mock_loaders["AIIndexLoader"]
    ...
    def test_refresh_cache(self, data_manager, mock_loaders):
        ...
        data_manager.cache["ai_index"] = {"data": {"old": "data"}, "timestamp": datetime.now()}
        data_manager.loaders["ai_index"] = mock_loaders["AIIndexLoader"]
        ...
        assert (
            data_manager.cache["ai_index"]["data"]
    ...
    def test_clear_cache(self, data_manager):
        """Test clearing cache."""
        # Setup cache
        data_manager.cache = {"ai_index": {"data": "test1"}, "mckinsey": {"data": "test2"}}
    ...
    def test_get_data_sources(self, data_manager):
        ...
        data_manager.loaders = {"ai_index": Mock(), "mckinsey": Mock(), "goldman": Mock()}
    ...
    def test_validate_data_integrity(self, data_manager, mock_loaders):
        ...
        mock_loaders["AIIndexLoader"].load.return_value = {"adoption_rates": test_df}
        data_manager.loaders["ai_index"] = mock_loaders["AIIndexLoader"]

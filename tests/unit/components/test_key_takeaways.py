...
class TestKeyTakeawaysGenerator:
    ...
    def test_generate_adoption_takeaways(self, generator):
        ...
        data = {"current_adoption": 65, "yoy_growth": 25, "industry_average": 80}
    ...
    def test_generate_competitive_takeaways(self, generator):
        ...
        critical_threats = [
            t for t in takeaways if t.category == "threat" and t.urgency == "critical"
        ]
    ...
    def test_generate_roi_takeaways(self, generator):
        ...
        data = {"expected_roi": 220, "payback_months": 8, "confidence_level": "high"}
        ...
        assert any(
            "strong" in t.message.lower() or "justif" in t.message.lower() for t in takeaways
        )
    ...
    def test_urgency_sorting(self, generator):
        ...
        sorted_takeaways = sorted(
            unsorted_takeaways, key=lambda x: ["critical", "high", "medium", "low"].index(x.urgency)
        )
    ...
    def test_generate_smart_summary(self, generator):
        ...
        test_df = pd.DataFrame({"metric": ["adoption", "roi", "growth"], "value": [87, 185, 15]})

        # Generate summaries for different personas
        exec_summary = generator.generate_smart_summary(
            test_df, "competitive_position", "Executive"
        )
        researcher_summary = generator.generate_smart_summary(
            test_df, "competitive_position", "Researcher"
        )
        ...
        assert (
            "analysis" in researcher_summary.lower() or "statistical" in researcher_summary.lower()
        )

    def test_labor_impact_takeaways(self, generator):
        """Test labor impact takeaway generation."""
        data = {"displacement_risk": 25, "augmentation_percentage": 55, "reskilling_gap": 70}
    ...
    def test_render_summary_box(self, generator, sample_takeaways):
        ...
        with StreamlitTestHelper.mock_streamlit() as mocks:
            ...
            generator.render_summary_box(
                ...
                additional_metrics={"ROI": "185%", "Payback": "18 months", "Risk": "Medium"},
            )
    ...
    def test_empty_data_handling(self, generator):
        ...
        # None values
        data_with_none = {"current_adoption": None, "yoy_growth": None, "industry_average": 72}
    ...
    def test_persona_specific_generation(self, generator):
        ...
        data = {"current_adoption": 75, "roi": 165, "implementation_time": 12}
        ...
        exec_has_roi = any(
            "roi" in t.message.lower() or "return" in t.message.lower() for t in exec_takeaways
        )
        assert exec_has_roi

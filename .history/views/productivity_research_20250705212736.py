...
def render(data: Dict[str, Any]) -> None:
    ...
    with tab1:
        _render_historical_context(productivity_data, a11y)

    with tab2:
        _render_skill_level_impact(productivity_by_skill, a11y)

    with tab3:
        _render_economic_estimates(ai_productivity_estimates, a11y)


def _render_historical_context(productivity_data, a11y):
...
def _render_skill_level_impact(productivity_by_skill, a11y):
...
def _render_economic_estimates(ai_productivity_estimates, a11y):

...
class EconomicInsights:
    ...
    def calculate_cost_of_inaction(
        ...
        confidence = models.get_confidence_intervals(
            results['total_cost'],
            'cost_of_inaction'
        )
        ...
        if scenario_type == "adoption_acceleration":
            ...
            for investment_mult in [0.5, 1.0, 1.5, 2.0]:
                ...
                scenario = {
                    ...
                    "adoption_rate": min(100, base_data.get('adoption', 20) * (1 + (investment_mult - 1) * 0.4)),
    ...
    def calculate_roi_projection(
        ...
        # Add confidence intervals
        confidence = models.get_confidence_intervals(
            roi_results['total_roi_percentage'],
            'roi'
        )
    ...
    def create_economic_calculator():
        ...
        with col1:
            ...
            industry = st.selectbox(
                ...
                ["Technology", "Financial Services", "Healthcare", 
                 "Retail", "Manufacturing", "Professional Services", "Other"],
        ...
        with col2:
            ...
            use_case = st.selectbox(
                "Primary Use Case",
                ["Customer Service Automation", "Sales & Marketing Optimization",
                 "Supply Chain Optimization", "Predictive Maintenance",
                 "Fraud Detection", "Document Processing", "Software Development",
                 "HR & Recruitment", "Default"],
...
class CompetitiveIntelligence:
    ...
    def assess_competitive_position(
        ...
        return {
            ...
            "catch_up_investment_required": adoption_gap * your_metrics.get('investment', 1000000) / 10
        }
...
# Continue with all remaining view implementations...
    ...
    **📈 Key Insights:**
    ...
    with geo_tabs[0]:  # ✅ NOW PROPERLY INDENTED UNDER THE elif
        # Enhanced interactive map with multiple layers
        st.subheader("AI Ecosystem Map: Adoption, Research & Investment")
        
        # ... rest of your tab 0 content here (all indented 4 more spaces) ...
    
    with geo_tabs[1]:  # ✅ PROPERLY INDENTED
        # Research infrastructure deep dive
        st.subheader("🏛️ Federal Research Infrastructure & NSF AI Institutes")
        
        # ... rest of your tab 1 content here (all indented 4 more spaces) ...
    
    with geo_tabs[2]:  # ✅ PROPERLY INDENTED
        # State-by-state comparison
        st.subheader("📊 State AI Ecosystem Comparison")
        
        # ... rest of your tab 2 content here (all indented 4 more spaces) ...
    
    with geo_tabs[3]:  # ✅ PROPERLY INDENTED
        # Academic centers analysis
        st.subheader("🎓 Academic AI Research Centers & University Ecosystem")
        
        # ... rest of your tab 3 content here (all indented 4 more spaces) ...
        
    with geo_tabs[4]:  # ✅ PROPERLY INDENTED
        # Investment flows analysis
        st.subheader("💰 AI Investment Flows: Private Capital & Government Funding")
        
        # ... rest of your tab 4 content here (all indented 4 more spaces) ...
    
    # Enhanced summary with authoritative insights (✅ PROPERLY INDENTED)
    st.markdown("---")
    st.subheader("🎯 Geographic AI Ecosystem: Key Findings & Policy Implications")
    
    # ... rest of your summary content (all indented 4 more spaces) ...

elif view_type == "OECD 2025 Findings":  # ✅ NOW THIS WILL WORK
    # Your OECD content here...

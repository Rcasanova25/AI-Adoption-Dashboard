...
from performance.cache_manager import get_cache, CacheKeyGenerator
...
class OptimizedPDFExtractor(PDFExtractor):
    ...
    def extract_tables(self, 
                      ...
                      parallel: bool = True) -> List[pd.DataFrame]:
    ...
    def _extract_tables_parallel(self, pages: List[int]) -> List[pd.DataFrame]:
        ...
        with ThreadPoolExecutor(max_workers=self.max_workers) as executor:
            # Submit tasks
            futures = {
                executor.submit(self._extract_page_tables, page): page
                for page in pages
            }

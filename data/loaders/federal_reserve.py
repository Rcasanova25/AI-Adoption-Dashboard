...
class RichmondFedLoader(BaseDataLoader):
    ...
    def __init__(self, file_path: Optional[Path] = None):
        ...
        source = DataSource(
            ...
            file_path=file_path,
            citation="Federal Reserve Bank of Richmond. 'The Productivity Puzzle: AI, Technology Adoption and the Workforce.r' Economic Focus, 2024.",
        )
...
class StLouisFedLoader(BaseDataLoader):
    ...
    def __init__(self, file_paths: Optional[List[Path]] = None):
        ...
        source = DataSource(
            ...
            citation="Federal Reserve Bank of St. Louis. 'Rapid Adoption of Generative AI' and 'Impact of Generative AI on Work Productivity.r' On the Economy Blog, 2024-2025.",
        )
        super().__init__(source)

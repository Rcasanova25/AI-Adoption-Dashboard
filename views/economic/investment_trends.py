...
class InvestmentTrendsView(BaseView):
    def __init__(self):
        super().__init__(
            title="AI Investment Trends: Record Growth in 2024",
            description="Analysis of AI investment trends, including overall trends, geographic distribution, GenAI focus, and comparative analysis."
        )
        self.a11y = AccessibilityManager()

    def render_content(self, data: Dict[str, pd.DataFrame]) -> None:
        """Render the investment trends view content.
        ...
        try:
            ...
            with tab1:
                self._render_overall_trends(ai_investment_data)

            with tab2:
                self._render_geographic_distribution()

            with tab3:
                self._render_genai_focus()
    ...
    def _render_overall_trends(self, ai_investment_data: pd.DataFrame) -> None:
    ...
    def _render_geographic_distribution(self) -> None:
    ...
    def _render_genai_focus(self) -> None:
...
investment_trends_view = InvestmentTrendsView()

def render(data: Dict[str, Any]) -> None:
    investment_trends_view.render(data)
...
def render(data: Dict[str, Any]) -> None:
    """Render the Geographic Distribution view.
    ...
    # Load geographic data from data sources
    enhanced_geographic = data.get("geographic", pd.DataFrame())
    state_research_data = data.get("state_data", pd.DataFrame())
    ...
    with geo_tabs[0]:
        _render_interactive_map(enhanced_geographic, state_research_data, a11y)

    with geo_tabs[1]:
        _render_research_infrastructure(state_research_data, a11y)

    with geo_tabs[2]:
        _render_state_comparisons(state_research_data, a11y)

    with geo_tabs[3]:
        _render_academic_centers(enhanced_geographic, state_research_data, a11y)

    with geo_tabs[4]:
        _render_investment_flows(enhanced_geographic, a11y)
...
def _render_interactive_map(
    enhanced_geographic: pd.DataFrame, state_research_data: pd.DataFrame, a11y: Any
) -> None:
...
def _render_research_infrastructure(state_research_data: pd.DataFrame, a11y: Any) -> None:
...
def _render_state_comparisons(state_research_data: pd.DataFrame, a11y: Any) -> None:
...
def _render_investment_flows(enhanced_geographic: pd.DataFrame, a11y: Any) -> None:

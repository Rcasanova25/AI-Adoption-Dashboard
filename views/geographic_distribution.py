...
def _render_interactive_map(enhanced_geographic: pd.DataFrame, state_research_data: pd.DataFrame, a11y: Any) -> None:
...
def _render_academic_centers(enhanced_geographic: pd.DataFrame, state_research_data: pd.DataFrame, a11y: Any) -> None:

...
def create_layout(data: Dict[str, Any], persona: str = "General") -> html.Div:
    """
    Create the layout for oecd_2025_findings view.
...
def create_header_section() -> html.Div:
    ...
    return html.Div([
        html.H2("📊 📊 **OECD/BCG/INSEAD 2025 Report: Enterprise AI Adoption", className="view-title mb-3"),
        html.P(
            "Analysis view for Oecd 2025 Findings", 

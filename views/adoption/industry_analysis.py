"""Industry Analysis view module for AI Adoption Dashboard.

This module provides authoritative visualizations and analysis of AI adoption,
GenAI penetration, and ROI by industry sector, with evidence-based insights.
"""
...
class IndustryAnalysisView(BaseView):
    def __init__(self):
        super().__init__(
            title="AI Adoption and ROI by Industry Sector",
            description="Authoritative visualizations and analysis of AI adoption, GenAI penetration, and ROI by industry sector."
        )
        self.a11y = AccessibilityManager()

    def render_content(self, data: Dict[str, pd.DataFrame]) -> None:
        """Render the Industry Analysis view content.
        ...
        try:
            ...
            if sector_2025 is None or sector_2025.empty:
                st.error(
                    "Required industry analysis data is missing or empty. Please check data sources."
                )
                st.stop()
            ...
            # Grouped bar chart for adoption rates
            fig.add_trace(
                go.Bar(
            ...
            fig = self.a11y.make_chart_accessible(
                ...
                title="AI Adoption and ROI by Industry Sector",
                description=(
                    "Combined bar and line chart showing AI adoption rates and ROI by industry sector. "
                    "Technology sector leads with 92% overall AI adoption and 88% GenAI adoption, achieving 4.2x ROI. "
                    "Financial Services follows with 85% overall adoption and 3.8x ROI. Healthcare shows 78% adoption with 3.2x ROI. "
                    "Government has the lowest adoption at 52% with 2.2x ROI."
                ),
            )
...
industry_analysis_view = IndustryAnalysisView()

def render(data: Dict[str, Any]) -> None:
    industry_analysis_view.render(data)
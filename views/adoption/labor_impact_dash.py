...
def create_layout(data: Dict[str, Any], persona: str = "General") -> html.Div:
    """
    Create the layout for labor_impact view.
...
def create_header_section() -> html.Div:
    ...
    return html.Div([
        html.H2("📊 👥 **AI's Impact on Jobs and Workers (AI Index Report 2025)", className="view-title mb-3"),
        html.P(
            "Analysis view for Labor Impact", 

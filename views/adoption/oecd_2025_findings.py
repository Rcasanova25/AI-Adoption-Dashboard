...
class OECD2025FindingsView(BaseView):
    def __init__(self):
        super().__init__(
            title="OECD/BCG/INSEAD 2025 Report: Enterprise AI Adoption",
            description="Analysis of enterprise AI adoption, including country comparisons, application trends, and success factors analysis."
        )
        self.a11y = AccessibilityManager()

    def render_content(self, data: Dict[str, Any]) -> None:
        """Render the OECD 2025 Findings view content.
        ...
        with tab1:
            self._render_country_analysis(oecd_g7_adoption, show_source_info)

        with tab2:
            self._render_application_trends(oecd_applications)

        with tab3:
            self._render_success_factors()

    def _render_country_analysis(self, oecd_g7_adoption, show_source_info):
    ...
    def _render_application_trends(self, oecd_applications):
    ...
    def _render_success_factors(self):
...
oecd_2025_findings_view = OECD2025FindingsView()

def render(data: Dict[str, Any]) -> None:
    oecd_2025_findings_view.render(data)